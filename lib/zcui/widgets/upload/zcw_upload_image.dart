...
class zcw_UploadImage extends StatefulWidget{
  @override
...
class _zcw_UploadImage_view extends State<zcw_UploadImage>{
  int number = 9;
  int widthpadding = 30;
  ...
  Future getImage() async {
    ...
    setState(() {
      imagelist.add({
        ...
        'status':1,
        'schedule':0,
        'imagepath':'https://p3.pstatp.com/list/190x124/pgc-image/RNJUG0LASkoZ6t',
      });
      imgkey = imgkey+1;
    });
  }
  ...
  Widget build(BuildContext context) {
    setState(() {
      itemheight = ((MediaQuery.of(context).size.width - widthpadding -((crossAxisCount-1)*mainAxisSpacing))/crossAxisCount);
    });
    // TODO: implement build
    return Container(
      height: ((imagelist.length+1)/crossAxisCount) >1
      ...
      child: Stack(
        children: <Widget>[
          Container(
            ...
            child: Stack(
              children: <Widget>[
                Container(height: itemheight, width: itemheight ,child: zcw_Image(imgurl: image['imagepath'],boxfit: BoxFit.cover,)),
                new Opacity(
                    opacity: 0.3,
                    child: new Container(
          ...
          Align(
            ...
            child: GestureDetector(
              child: Container(
                  ...
                  child: Center(child:Icon(Icons.cancel,size: 15,color: Color(0xffffffff),),)
              ),onTap: (){
                setState(() {
  ...
  Widget addnewImage(){
    return GestureDetector(
      ...
      child: Icon(Icons.image,color: Color(0xff888888),size: 50,),
      ),onTap: (){

...
import 'zcw_playerWithControls.dart';
...
/// make it easy to use!
class zcw_Chewie extends StatefulWidget {
...
class _ChewiePlayerState extends State<zcw_Chewie> {
  ...
  Widget build(BuildContext context) {
    ...
    return new Container(
      height: playerHeight,
      child: new zcw_PlayerWithControls(
      ...
      body: new Container(
        ...
        child: new zcw_PlayerWithControls(
          ...
          onExpandCollapse: () async {
            await new Future<dynamic>.value(Navigator.of(context).pop());
            setState(() {
  ...
  @override
  void didUpdateWidget(zcw_Chewie oldWidget) {

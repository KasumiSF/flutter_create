...
class zcw_videoMaterialControls extends StatefulWidget {
...
class _MaterialControlsState extends State<zcw_videoMaterialControls> {
          ...
          new Container(
            ...
            child: new Row(
              children: <Widget>[
                ...
                _buildProgressBar(),
                _buildMuteButtonx(widget.controller),
  ...
  @override
  void didUpdateWidget(zcw_videoMaterialControls oldWidget) {
  ...
  GestureDetector _buildExpandButtonx() {
  ...
  GestureDetector _buildMuteButtonx(
      VideoPlayerController controller,
      ) {
    return new GestureDetector(
      onTap: () {
        ...
        child: new MaterialVideoProgressBar(
          ...
          colors: widget.progressColors ??
              new ChewieProgressColors(
                  playedColor: Color(0xff53AAF0),
                  handleColor: Color(0xff53AAF0),
